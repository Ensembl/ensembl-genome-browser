...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('peregrine_generic_bg.wasm', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('peregrine_generic-0575cd42.js', document.baseURI).href)));
    }
    const imports = {};
    imports.wbg = {};
