...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('peregrine_ensembl_bg.wasm', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('peregrine_ensembl-6533506d.js', document.baseURI).href)));
    }
    const imports = {};
    imports.wbg = {};
