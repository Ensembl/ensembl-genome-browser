...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('peregrine_ensembl_bg.wasm', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('peregrine_ensembl-51a2bc18.js', document.baseURI).href)));
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbindgen_closure_wrapper3211 = function(arg0, arg1, arg2) {
        var ret = makeMutClosure(arg0, arg1, 93, __wbg_adapter_40);
        return addHeapObject(ret);
    };
